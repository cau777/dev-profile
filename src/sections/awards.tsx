        ...
        <SectionWrapper title={"Math Award"} size="md">
            <Group wrap={wrap}>
                ...
                <Text>
                    ...
                    Brazilian National Math Olympiad (OBMEP)</Anchor>. OBMEP is considered the largest science Olympiad in
                    Brazil and in the world, with the participation of 18.5 million students and 5,564 cities. I got a
                    silver medal meaning being in the top 500 of the whole country (there are a lot of ties).
                </Text>
                <Text>
                    The tests are very focused on logic and problem solving, and require providing a walkthrough of the
                    thought process and techniques used.
                </Text>
                </Stack>
            </Group>
        </SectionWrapper>
