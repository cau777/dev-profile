...
export const CareerSvgContents: Component<RocketSvgContentProps> = (props) => {
  return (
    <>
      ...
      <LifePoint visible={props.visible && props.lineLength > 28} title='Started learning Python' time={'Middle of 2018'} direction={'up'}
                 x={31} y={145}
                 length={40}>
        I decided to start learning Python (because it's more beginner friendly) with some free tutorials online
      </LifePoint>
      <LifePoint visible={props.visible && props.lineLength > 73} title='Simple programs for Hobby' time={'2018-2020'} direction={'right'}
      ...
      <LifePoint visible={props.visible && props.lineLength > 130} title='JetBrains Academy' time={'2020-2022'} direction={'right'}
      ...
      <LifePoint visible={props.visible && props.lineLength > 176} title='Built an AI from scratch' time={'2022-2023'} direction={'right'}
      ...
      <LifePoint visible={props.visible && props.lineLength > 200} title='Intern at Aerial' time={'April 2023'} direction={'right'}
      ...
      <LifePoint visible={props.visible && props.lineLength > 230} title='Full-Stack Developer' time={'September 2023'} direction={'left'}
                 x={180} y={30} length={120}>
        After the internship period was over, I joined Aerial as a Full-Stack Developer
      </LifePoint>
      <LifePoint visible={props.visible && props.lineLength > 235} title='Full-Stack Developer' time={'October 2023'} direction={'right'}
