export default {
    ...
    "description_5": "",
    "subtitle_1": "Tu tenho quase 18 anos e se tem",
    "subtitle_2": "uma",
    "subtitle_3": "coisa que eu sei é que amo encontrar soluções criativas para problemas.",
    "subtitle_4": "Além disso, gosto de construir aplicações grandes e pequenas, enquanto trabalhando no frontend e/ou backend.",
    
    "aboutMe_1": "Eu sou brasileiro e Português é minha língua nativa, mas eu também sou fluente em inglês (C1).",
    "aboutMe_2": "Eu comecei a programar em 2017 como um hobby, mas começei a aprender serialmente em 2021.",
    "aboutMe_3": "Nesse tempo, eu fiz vários cursos e criei vários projetos open-source no meu GitHub, explorando tecnologias diversas.",
    "aboutMe_4": "Agora, eu estarei estudando Engenharia de Software na Unijuí de 2023 a 2028.",
